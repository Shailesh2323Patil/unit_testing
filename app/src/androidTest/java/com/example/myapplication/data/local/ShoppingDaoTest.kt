...
class ShoppingDaoTest {
    ...
    fun observeTotalPriceSum() = runBlockingTest {
        ...
        val shoppingItem3 = ShoppingItem("name",0,10f,"url",3)
    ...
    fun observeAllShoppingItems() = runBlockingTest {
        ...
        val shoppingItem3 = ShoppingItem("name",2,10f,"url",3)

        dao.insertShoppingItem(shoppingItem1)
        dao.insertShoppingItem(shoppingItem2)
        dao.insertShoppingItem(shoppingItem3)

        val totalShoppingItems = dao.observeAllShoppingItems().getOrAwaitValue()

        assertThat(totalShoppingItems.size).isEqualTo(3)
    }
}